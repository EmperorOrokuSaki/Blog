---
layout: minimal
title: "Building Private Stablecoin Payroll Together: The Mirage Design Partnership"
description: "A nine-week engagement to build and co-publish an end-to-end reference for private stablecoin payroll. Applications close May 31, 2026."
cover: "/assets/design-partnership.webp"
authors:
  - "[Arno Pernthaler](https://www.linkedin.com/in/arno-pernthaler/)"
authorImg: "/assets/arno.webp"
date: 2026-05-21
tags: ["announcement", "partnerships"]
---

export const base = import.meta.env.BASE_URL.replace(/\/?$/, '/')

# Building Private Stablecoin Payroll Together: The Mirage Design Partnership

::authors

<img
  src={`${base}assets/design-partnership.webp`}
  alt="The Mirage Design Partnership"
...
Today we're opening applications for the Mirage Design Partnership: a nine-week engagement to build and co-publish a working end-to-end reference journey and the integrations behind it for private stablecoin payroll. Applications close May 31, 2026. The full [Design Partnership Brief](https://drive.google.com/file/d/15T0pdB6HjRcJI5IOp27kDTRsUuJ41QoA/view?usp=drive_link) covers the architecture, partner roles, timeline, and terms in detail.
...
If this is the kind of work you're already doing, we'd like to do it with you. The [Design Partnership Brief](https://drive.google.com/file/d/15T0pdB6HjRcJI5IOp27kDTRsUuJ41QoA/view?usp=drive_link) has the full details; the application itself is a short reply to [partners@mirageprivacy.com](mailto:partners@mirageprivacy.com) with your role interest, a technical reference, and a contact for the integration window.
